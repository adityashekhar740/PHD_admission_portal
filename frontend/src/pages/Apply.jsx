...
function Apply() {
  ...
  const handleChange = (e) => {
    if(e.target.id==='noPermanent'||e.target.id==='yesPermanent'){
          setFormData({...formData,addressDetails:{...formData.addressDetails,isPermanentAddress:e.target.id}});
    }
    else{
      setFormData({ ...formData, personalDetails:{...formData.personalDetails,[e.target.id]: e.target.value} });
    }
  };
  const handleChange2=(e)=>{
          setFormData({...formData,parentDetails:{...formData.parentDetails,[e.target.id]:e.target.value}})
  ...
  const handleChange3=(e)=>{
      if(e.target.id==='noPermanent'||e.target.id==='yesPermanent'){
       ...
       setFormData({...formData,addressDetails:{...formData.addressDetails,[e.target.id]:e.target.value}})
    }
  }
      ...
      <div className="bg-[#eaeaea] h-[222vh] ">
        <div className="max-w-[1100px]   mx-auto h-[130vh]">
          ...
          <div className="flex gap-5 overflow-x-auto max-w-full mt-5 ">
            <a href="#programDetails" className="min-w-[200px] h-[30px]">
              Program and basic details
            </a>
            <a href="#parentDetails" className="min-w-[200px]">Parent's Details</a>
          ...
          <div className="w-[100%] py-4 px-3  bg-white mt-5 border-solid border-gray-300 border-[0.5px] ">
            <div id="programDetails" >
              <h1 className="text-lg text-[#e45c37] mb-4 font-semibold ">Program Details</h1>
              ...
              <div className="pt-[50px]">
                <h1 className="text-lg text-[#e45c37] mb-4 font-semibold ">Personal Details </h1>
                {/* start of 1st row */}
                <div className="flex flex-col gap-10">
                  <div className="flex gap-4 justify-evenly ">
                    <div className="flex flex-col gap-1 w-[22%]">
                      <label htmlFor="title">Title</label>
                      <select onChange={(e)=>{handleChange(e)}} className="border py-2 px-1" name="" id="title">
                  ...
                  <div className="flex gap-4 justify-evenly ">
                    ...
                    <div className="flex flex-col gap-1 w-[22%]">
                      ...
                      <select onChange={(e)=>{handleChange(e)}} className="border py-2 px-1" name="" id="gender">
                  ...
                  <div className="flex  justify-start pl-4 gap-7 ">
                    ...
                    <div className="flex flex-col gap-1 w-[22%]">
                      ...
                      <select onChange={(e)=>{handleChange(e)}} className="border py-2 px-1" name="" id="caste">
                        <option value="">select</option>
              ...
              <div className="flex w-full justify-center my-[50px]  " >
                <button disabled={personalDetailDone} onClick={()=>setpersonalDetailDone(true)} className=" disabled:opacity-80 w-[15%] bg-[#e45c37] text-white py-2 px-1 rounded-sm " >Next</button>
              </div>
              {
                personalDetailDone?<div>
                    {/* father's details */}
                  <div className="w-full border-b-[3px] h-[1px] border-dotted mt-[50px] border-gray-500   "></div>
                  <div id="parentDetails" className="pt-[50px]" >
                      <h1 className="text-lg text-[#e45c37] mb-4 font-semibold ">Father's Details </h1>
                    <div className="flex gap-4 justify-evenly ">
                    <div className="flex flex-col gap-1 w-[22%]">
                      <label htmlFor="Ftitle">Title</label>
                      <select onChange={(e)=>{handleChange2(e)}} className="border py-2 px-1" name="" id="Ftitle">
                        <option value="">select</option>
                        <option value="Mr">Mr</option>
                  ...
                  {/* mother's details */}
                  <div className="pt-[50px]" >
                      <h1 className="text-lg text-[#e45c37] mb-4 font-semibold ">Mother's Details </h1>
                    <div className="flex gap-4 justify-evenly ">
                    <div className="flex flex-col gap-1 w-[22%]">
                      <label htmlFor="Mtitle">Title</label>
                      <select onChange={(e)=>{handleChange2(e)}} className="border py-2 px-1" name="" id="Mtitle">
                        <option value="">select</option>
                        <option value="Mrs">Mrs</option>
                        <option value="Dr">Dr</option>
                      </select>
                    ...
                    <div className="flex flex-col gap-1 w-[22%]">
                     ...
                     <div className="flex w-full justify-center my-[50px]  " >
                <button disabled={ParentDetailDone} onClick={()=>setParentDetailDone(true)} className=" disabled:opacity-85 w-[15%] bg-[#e45c37] text-white py-2 px-1 rounded-sm " >Next</button>
              </div>
                  </div>
              </div>:null
              }

              {
                ...
                <div>
                  <div className="w-full border-b-[3px] h-[1px] border-dotted mt-[50px] border-gray-500   "></div>
                  <div className="pt-[50px]  " >
                      <h1 className="text-lg text-[#e45c37] mb-4 font-semibold ">Address Details </h1>
                    <div className="flex flex-col gap-4 justify-evenly px-4 ">
                    <textarea onChange={(e)=>handleChange3(e)} name="" className="border" id="address" cols="120" rows="2"></textarea>
                    <div className="flex flex-col gap-2" >
                      <label htmlFor="">Is this your Permanent Adress</label>
                      <div className="flex gap-2" >
                        <input onChange={(e)=>handleChange3(e)} checked={formData.addressDetails.isPermanentAddress==='yesPermanent'} type="radio" name="" id="yesPermanent" />
                        <label htmlFor="yesPermanent">Yes</label>
                    <input onChange={(e)=>handleChange3(e)} checked={formData.addressDetails.isPermanentAddress==='noPermanent'} type="radio" name="" id="noPermanent" />
                     ...
                     <div className="flex w-full justify-center my-[50px]  " >
                <button disabled={addressDetailDone} onClick={()=>setAddressDetailDone(true)} className=" disabled:opacity-85 w-[15%] bg-[#e45c37] text-white py-2 px-1 rounded-sm " >Next</button>
              </div>
                  </div>
                </div>
                :null
