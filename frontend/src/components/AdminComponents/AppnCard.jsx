...
import './AdminCss.css';
function AppnCard({app,AppnApproved}) {
    ...
    <>
    {
      ...
      <div className="h-[75px] w-full flex bg-white rounded-sm border items-center   ">
          ...
          <div className="flex justify-between w-[90%] h-[100%]  items-center ">
            ...
            <p className='ml-3 text-[11.4px] ' >Applied On: {app.date.split('T')[0]}</p>
            </div>
              ...
              <div className="flex items-center px-7 border-solid border-x-[0.1px] border-gray-300 ">
                <h1 className="text-[#666666] ">
                      <span className=" font-semibold text-gray-500 ">
                        {
                          app.status==='accepted'?<h1 className='text-green-500' >Approved 🎉 </h1>:"Pending..."
                        }
                      </span>
                    </h1>
     ...
     {
      modalOpen?<AppnModal app={app} setModelOpen={setModelOpen} />:null
     }
